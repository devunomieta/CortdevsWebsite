                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="prose prose-neutral max-w-none space-y-8 text-neutral-600">
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-black mb-4">3. Use of Your Information</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-black mb-4">5. Third-Party Sharing</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-black mb-4">6. Contact Us</h2>
                                <p>
                                    If you have any questions about this Privacy Policy, please contact us at
                                    <span className="text-black ml-1">privacy@cortdevs.com</span>.
                                </p>
                            </section>
                        </div>
