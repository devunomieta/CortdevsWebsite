                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="prose prose-neutral max-w-none space-y-8 text-neutral-600">
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-black mb-4">2. Scope of Services</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-black mb-4">4. Confidentiality & NDAs</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-black mb-4">5. Limitation of Liability</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-black mb-4">6. Governing Law</h2>
                                <p>
                        ...
                        <div className="mt-20 pt-8 border-t border-neutral-100 text-sm text-neutral-400">
